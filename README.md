...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18891177.svg)](https://doi.org/10.5281/zenodo.18891177)
...
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18891177](https://doi.org/10.5281/zenodo.18891177) |
| Platform | Zenodo |
| License | CC0 1.0 |

## Access
🔗 **[Download from Zenodo](https://doi.org/10.5281/zenodo.18891177)**

## Citation
> de la Serna Tuya, J.M. (2026). *Evolucion Poblacional Edad Latam*. Zenodo. https://doi.org/10.5281/zenodo.18891177
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Population evolution by age groups in Latin America. CC0 1.0* [Dataset]. GitHub. https://github.com/juanmoisesd/evolucion-poblacional-edad-latam

**BibTeX**
```bibtex
@dataset{delaserna2025_evolucion_poblacional_edad_lat,
...
> de la Serna, J. M. (2026). *Evolucion Poblacional Edad Latam*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/evolucion-poblacional-edad-latam 10.5281/zenodo.19145316

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **evolucion poblacional edad latam**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
