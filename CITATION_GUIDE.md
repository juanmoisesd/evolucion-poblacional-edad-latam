...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Evolución Poblacional por Edad en Latinoamérica: Dataset Longitudinal. GitHub. https://github.com/juanmoisesd/evolucion-poblacional-edad-latam
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Evolución Poblacional por Edad en Latinoamérica: Dataset Longitudinal." GitHub. https://github.com/juanmoisesd/evolucion-poblacional-edad-latam.
```
...
@misc{delaserna2026_evolucionpob,
  ...
  title        = {Evolución Poblacional por Edad en Latinoamérica: Dataset Longitudinal},
  year         = {2026},
...
TI  - Evolución Poblacional por Edad en Latinoamérica: Dataset Longitudinal
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/evolucion-poblacional-edad-latam
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Evolución Poblacional por Edad en Latinoamérica: Dataset Longitudinal. GitHub; 2026. Available: https://github.com/juanmoisesd/evolucion-poblacional-edad-latam. ORCID: 0000-0002-8401-8018.
```
